 ...
 * - Changed GWT link updated
 * - Added pattern to support vanilla javascript library
 * 
 * @author davidshimjs
 * @see <a href="http://www.d-project.com/" target="_blank">http://www.d-project.com/</a>
 * @see <a href="http://jindo.dev.naver.com/collie" target="_blank">http://jindo.dev.naver.com/collie</a>
 */
...
class QRCodeModel {
	constructor(qrCode, typeNumber, errorCorrectLevel) {
		this.qrCode = qrCode;
...
class QRCode {
	constructor(options) {
		...
		if (typeof this._htOption.el === 'string') {
			this._el = document.getElementById(this._htOption.el);
		} else {
